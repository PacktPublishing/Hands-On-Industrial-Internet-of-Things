...
export declare class Mqtt extends EventEmitter implements DeviceTransport {
    ...
    private _extractPropertiesFromTopicPart(properties, msg);
    private _onInputMessage(topic, payload);
    private _onDeviceMethod(topic, payload);
    private _getEventTopicFromMessage(message, extraSystemProperties?);

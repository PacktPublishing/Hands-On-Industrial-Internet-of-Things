...
const _defaultType = [
    ...
    // see OPCUA Part 3 - V1.02 $8.2.1
    {
        ...
        defaultValue: require("node-opcua-nodeid").makeNodeId,
        coerce: ec.coerceNodeId
    },

    {
        name: "ExpandedNodeId",
        encode: ec.encodeExpandedNodeId, decode: ec.decodeExpandedNodeId,
        defaultValue: require("node-opcua-nodeid/src/expanded_nodeid").makeExpandedNodeId,
        coerce: ec.coerceExpandedNodeId
    },

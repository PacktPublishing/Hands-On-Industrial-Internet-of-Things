...
var duplexify = __importStar(require("duplexify"));
...
var GrpcService = /** @class */ (function (_super) {
    ...
    GrpcService.prototype.request = function (protoOpts, reqOpts, callback) {
        ...
        var respError;
        var retryOpts = extend_1.default({
        ...
        return retry_request_1.default(null, retryOpts, function (err, resp) {
    ...
    GrpcService.prototype.requestStream = function (protoOpts, reqOpts) {
        ...
        var retryOpts = extend_1.default({
            ...
            shouldRetryFn: GrpcService.shouldRetryRequest_,
            request: function () {
                return service[protoOpts.method](reqOpts, grpcMetadata, grpcOpts).on('metadata', function () {
        ...
        return retry_request_1.default(null, retryOpts)
    ...
    GrpcService.decorateGrpcResponse_ = function (obj, response) {
        if (response && GRPC_ERROR_CODE_TO_HTTP[response.code]) {
            ...
            return extend_1.default(true, obj, response, {
    ...
    GrpcService.prototype.decorateRequest_ = function (reqOpts) {
        reqOpts = extend_1.default({}, reqOpts);
        delete reqOpts.autoPaginate;
        delete reqOpts.autoPaginateVal;
        delete reqOpts.objectMode;
        return common_1.util.replaceProjectIdToken(reqOpts, this.projectId);
    };
    /**
    ...
    GrpcService.prototype.getService_ = function (protoOpts) {
        ...
        if (!service) {
            service = new proto[protoOpts.service](proto.baseUrl || this.baseUrl, this.grpcCredentials, extend_1.default({
